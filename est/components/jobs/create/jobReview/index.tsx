...
import CandidateDetailsReview from "./candidateDetailsReview";
import WorkExperienceReview from "./workExperienceReview";
import SkillsReview from "./skillsReview";
import EducationDetailsReview from "./educationDetailsReview";
		...
		<>
			<div className="setting-container">
				<div className="tab-detail-span mt-10">
					Review your targeting criteria and job description, before posting this job.
				</div>
				...
				<div className="job-preview-wrapper mt-20">
					<div className="w-60">
						...
						<div className="mt-20">
							...
							that implements intelligent workflows to streamline care delivery and revolutionizes the pet care
							experience outside the care setting. We offer an end-to-end platform that unifies fragmented health care
							data to enable providers, payors, and life science companies to automate care delivery operations - from
							patient communication to documentation to reimbursement. We uniquely use artificial intelligence to
							digitize existing care delivery workflows, giving vets infrastructure that learns from every encounter
							they have.
						</div>
						...
						<div className="mt-10">
							Lead user-centered research throughout the product development process, from discovery to delivery, using
							a variety of qualitative and quantitative research methods (e.g., interviews, surveys, usability tests,
						...
						<div className="mt-10">
							An experienced UX researcher who has worked on an agile team and shipped products and features for at
							least a few years. Experience leading research projects across the entire product lifecycle. Experience
							planning research to address knowledge gaps, to enable us to make better product decisions. Experience
							aligning and facilitating decision-making with stakeholders. Experience collaborating with product
							managers, designers, engineers, and other internal stakeholders; you are inclusive in your approach to
							research and employ a variety of methods to get the best ideas and questions out of your team.
						</div>
					</div>
				</div>
			</div>

			<BottomNavigation submitBtnName="Post a Job" />
		</>
	);
};
